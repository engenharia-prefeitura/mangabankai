...
<body>
  ...
  <div class="detail-body container">
    <div class="detail-tab-content active">
      ...
      <p class="takedown-link"><a href="/takedown.html?manga=${encodeURIComponent(id)}" rel="nofollow">© É o titular dos direitos desta obra? Solicitar desindexação</a></p>
    </div>
    ...
    <div class="container">
      <div class="footer-grid">
        <div class="footer-brand">
          ...
          <p>MangaBankai é um indexador de mangás online — os links apontam para conteúdos hospedados por terceiros.</p>
        </div>
        <div>
          <h4>Navegação</h4>
          <ul>
      ...
      <div class="footer-bottom">
        <p>&copy; 2026 ${SITE_NAME}. Lages-SC. Indexamos links públicos de terceiros; não hospedamos nenhum conteúdo.</p>
      </div>
    </div>
  </footer>
